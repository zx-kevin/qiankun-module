  ...
  <div class="app-container">
    ...
    >
      <template #dictLabel="{ row }">
        ...
        <el-tag v-else :type="row.listClass == 'primary' ? '' : row.listClass">{{
          row.dictLabel
        }}</el-tag>
      </template>
...
import { optionselect as getDictOptionselect, getType } from '@/api/module/system/dict/type';
import { listData, getData, delData, addData, updateData } from '@/api/module/system/dict/data';

<template>
  <div class="app-container">
    ...
    <!-- 添加或修改定时任务对话框 -->
    <Dialog :title="title" v-model:visible="open" width="800px" appendToBody>
      <template #content>
                    ...
                    <el-tooltip placement="top">
                      <template #content>
                        <div>
                          ...
                          <br />Class类调用示例：com.jeoho.quartz.task.RyTask.ryParams('ry')
    ...
    <Dialog title="Cron表达式生成器" v-model:visible="openCron" appendToBody destroyOnClose>
      <template #content>
        <crontab
          ref="crontabRef"
          @hide="openCron = false"
    ...
    <!-- 任务日志详细 -->
    <Dialog title="任务详细" v-model:visible="openView" width="700px" appendToBody>
      <template #content>
...
const tableCol = [
  { label: '任务编号', prop: 'jobId', align: 'center' },
  { label: '任务名称', prop: 'jobName', align: 'center' },
  { label: '任务组名', prop: 'jobGroup', align: 'center' },
...
const tableOpt = {
  ...
  list: [
    ...
    { title: '执行一次', show: () => true, methods: handleRun },
    { title: '任务详细', show: () => true, methods: handleView },
    { title: '调度日志', show: () => true, methods: handleJobLog },
  ],
};

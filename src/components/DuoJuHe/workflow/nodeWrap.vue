      ...
      >
        <div>
          ...
          <div class="content" @click="setPerson">
            <div class="text" style="text-align: center" v-if="nodeConfig.type == 0">

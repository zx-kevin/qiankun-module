  ...
  <div class="visit-card-message">
    <div class="user flex-center">
      <div class="avatar flex-center">
        <el-avatar :size="28" :src="headPortrait" />
      </div>
      <div class="content flex-center">
        <p class="ellipsis">{{ realName }}</p>
      </div>
      <div class="tools flex-center">
        <span class="flex-center pointer"> <i class="el-icon-plus" /> 加好友 </span>
      </div>
    </div>
    <div class="sign"><span>个性签名 : </span>{{ motto }}</div>
...
export default {
  ...
  data() {
    return {
      ...
      friendId: 0,
      headPortrait: '',
      motto: '这个社会，是赢家通吃，输者一无所有，社会，永远都是只以成败论英雄。',
      realName: '多聚合',
    };
  },
  created() {},

...
export const selectComponents = [
    ...
    },
    {
        ...
        action: getAppApiUrl() + '/formProjectPublic/upload/fileSingleUploadToFileAbsolutePath',
        disabled: false,
        accept: '',
        showFileList:true,
        name: 'file',
...
export const assistComponents = [
    ...
    },
  {
    ...
    },
    {
        ...
        color: '#000000',
        style: {width: '100%'},
        action: '/formProjectPublic/upload/imageSingleUploadToImageBase64'
    },
    {
        typeId: 'FORM_PAGINATION',
        __config__: {
            label: '分页',
            defaultValue: '分页',
            displayType: true,
...
/*  {
    ...
    __slot__: {
      default: '主要按钮' // 指的是 <el-button>{{ __slot__.defulat的值(非defualt的将被<template>包裹)}}}</el-button>
    },
    type: 'primary',
    icon: 'el-icon-search',
    round: false,

...
export const toolbar = [
    ' styleselect bold italic underline | strikethrough undo redo  blockquote | removeformat alignleft aligncenter alignright | subscript superscript  hr bullist | numlist link image charmap preview | insertdatetime media table | emoticons forecolor backcolor '
]

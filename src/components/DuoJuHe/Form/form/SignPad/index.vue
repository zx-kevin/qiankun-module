<template>
  <div id="signature-pad" class="signature-pad">
    ...
    <div v-if="!signImageUrl">
      <el-button plain size="default" type="danger" @click="clear">清除</el-button>
      <el-button plain size="default" type="warning" @click="undo">回撤</el-button>
      <el-button size="default" type="success" @click="savePng">确认</el-button>
    </div>
    <div v-if="signImageUrl">
      <el-button size="default" type="primary" @click="reSign">重签</el-button>
    </div>
  </div>
</template>
...
import { uploadFile } from '@/api/common/fileUpload';
export default {
  name: 'SignPad',
  components: {},
  props: {
  ...
  methods: {
    ...
    savePng() {
      ...
      uploadFile(this.action, param).then((res) => {

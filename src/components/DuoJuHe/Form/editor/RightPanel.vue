    ...
    <div class="field-box" v-if="activeData">
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" label-width="90px" size="small">
          ...
          <el-form-item
            v-if="
              activeData.__config__.label !== undefined && activeData.__config__.showLabel !== false
            "
            label="标题"
          >
            <el-input
          ...
          <el-form-item
            v-if="activeData.placeholder !== undefined && activeData.placeholder !== ''"
            label="占位提示"
          >
            <el-input
          ...
          >
            ...
            <div style="margin-left: 20px">
              ...
              <el-button
                v-if="
                  ['el-checkbox-group', 'el-radio-group'].indexOf(activeData.__config__.tag) > -1
                "
                icon="el-icon-circle-plus-outline"
                style="padding-bottom: 0"
                type="text"
...
import TreeNodeDialog from '@/components/DuoJuHe/Form/editor/TreeNodeDialog';
import { isNumberStr } from '@/utils/duojuhe';
import IconsDialog from './IconsDialog';
import { assistComponents, selectComponents } from '@/components/DuoJuHe/Form/generator/config';
import { saveFormConf } from '@/utils/form/utils/cache';
import { debounce } from 'throttle-debounce';
import draggable from 'vuedraggable';
import _ from 'lodash';
import { getToken, getSignKey, getAppApiUrl } from '@/utils/auth';
  ...
  methods: {
    ...
    addSelectItem() {
      ...
      this.activeData.__slot__.options.push({
        ...
        value: lastItem
          ? lastItem.value === 0
            ? _.max(_.values(this.activeData.__slot__.options.map((item) => item.value))) + 1
            : lastItem.value + 1
          : 1,
      });
    },
    ...
    tagChange(tagIcon) {
      let target = assistComponents.find((item) => item.__config__.tagIcon === tagIcon);
